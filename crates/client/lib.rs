...
use queensgame_shared_room_minesweeper::{
    ...
    optimistic_room_minesweeper_chord_snapshot as shared_optimistic_room_minesweeper_chord_snapshot,
    optimistic_room_minesweeper_reveal_snapshot as shared_optimistic_room_minesweeper_reveal_snapshot,
    optimistic_room_minesweeper_toggle_flag_snapshot as shared_optimistic_room_minesweeper_toggle_flag_snapshot,
...
fn optimistic_room_minesweeper_reveal_snapshot(
    ...
    shared_optimistic_room_minesweeper_reveal_snapshot(snapshot, player_id, index, current_time_ms);
}
...
fn optimistic_room_minesweeper_toggle_flag_snapshot(
    ...
    shared_optimistic_room_minesweeper_toggle_flag_snapshot(snapshot, player_id, index);
}
...
fn optimistic_room_minesweeper_chord_snapshot(
    ...
    shared_optimistic_room_minesweeper_chord_snapshot(snapshot, player_id, index, current_time_ms);
}
